...
<simconf>
  ...
  <simulation>
    ...
    <motetype>
      ...
      <commands EXPORT="discard">make xmpp-extended.z1 TARGET=z1</commands>
      <firmware EXPORT="copy">[CONTIKI_DIR]/examples/xmpp-example/xmpp-extended.z1</firmware>
      <moteinterface>se.sics.cooja.interfaces.Position</moteinterface>
      <moteinterface>se.sics.cooja.interfaces.RimeAddress</moteinterface>
      <moteinterface>se.sics.cooja.interfaces.IPAddress</moteinterface>
      <moteinterface>se.sics.cooja.interfaces.Mote2MoteRelations</moteinterface>
  ...
  <plugin>
    ...
    <plugin_config>
      ...
      <viewport>21.320498183748203 0.0 0.0 21.320498183748203 -360.3991927965087 -470.9174258775773</viewport>
    </plugin_config>
    <width>819</width>
    <z>0</z>
    <height>563</height>
