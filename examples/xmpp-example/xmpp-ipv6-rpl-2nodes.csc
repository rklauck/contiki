...
<simconf>
  ...
  <simulation>
    ...
    <motetype>
      ...
      <description>Sky Mote XMPP client</description>
      <source EXPORT="discard">[CONTIKI_DIR]/examples/xmpp-example/xmpp-client.c</source>
      <commands EXPORT="discard">make xmpp-client.sky TARGET=sky</commands>
      <firmware EXPORT="copy">[CONTIKI_DIR]/examples/xmpp-example/xmpp-client.sky</firmware>
      <moteinterface>se.sics.cooja.interfaces.Position</moteinterface>
      <moteinterface>se.sics.cooja.interfaces.RimeAddress</moteinterface>
      <moteinterface>se.sics.cooja.interfaces.IPAddress</moteinterface>
      <moteinterface>se.sics.cooja.interfaces.Mote2MoteRelations</moteinterface>
    ...
    <mote>
      ...
      <interface_config>
        se.sics.cooja.interfaces.Position
        <x>34.569966760244405</x>
        <y>33.497847631874066</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        se.sics.cooja.mspmote.interfaces.MspMoteID
    ...
    <mote>
      ...
      <interface_config>
        se.sics.cooja.interfaces.Position
        <x>29.06824534435142</x>
        <y>24.509454939109425</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        se.sics.cooja.mspmote.interfaces.MspMoteID
  ...
  <plugin>
    ...
    <plugin_config>
      ...
      <viewport>7.453891284600996 0.0 0.0 7.453891284600996 -69.67154063090453 -97.69081256094856</viewport>
    </plugin_config>
    <width>819</width>
    <z>1</z>
    <height>563</height>
