...
allow_unencrypted_plain_auth = true -- IMPORTANT for our uXMPP !!!
...
VirtualHost "anon.localhost"
	anonymous_login = true -- Prosody 0.7
	authentication = "anonymous" -- Prosody 0.8+

	disallow_s2s = false -- Allow s2s
